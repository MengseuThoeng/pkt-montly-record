  ...
  return (
    <>
      ...
      <ConfirmationDialog
        ...
        description={
          recordToDelete
            ? `Are you sure you want to delete the record for "${recordToDelete.customerName}" - Order: "${recordToDelete.order}"? This action cannot be undone.`
            : ""
        }
        confirmText="Delete"
        cancelText="Cancel"
        onConfirm={handleConfirmDelete}
        isLoading={isDeleting === recordToDelete?.id}
        variant="destructive"
      />
    </>
  )
